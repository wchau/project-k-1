...
import com.example.project_k.app.util.AuthUtil;
...
public class UploadUtil {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Credential credential = AuthUtil.authorize(scopes, "uploadvideo");

            // This object is used to make YouTube Data API requests.
            youtube = new YouTube.Builder(AuthUtil.HTTP_TRANSPORT, AuthUtil.JSON_FACTORY, credential).setApplicationName(
            ...
            InputStreamContent mediaContent = new InputStreamContent(VIDEO_FILE_FORMAT,
                    UploadUtil.class.getResourceAsStream("/sample-video.mp4"));
